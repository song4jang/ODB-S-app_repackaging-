========================================================================
    콘솔 응용 프로그램 : ODB_S_Automation_Console 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 ODB_S_Automation_Console 응용 프로그램을 만들었습니다.

ODB_S_Automation_Console 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


ODB_S_Automation_Console.vcxproj
...
ODB_S_Automation_Console.vcxproj.filters
...
ODB_S_Automation_Console.cpp
    기본 응용 프로그램 소스 파일입니다.

/////////////////////////////////////////////////////////////////////////////
응용 프로그램 마법사에서 다음 리소스를 만들었습니다.

ODB_S_Automation_Console.rc
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 ODB_S_Automation_Console.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
